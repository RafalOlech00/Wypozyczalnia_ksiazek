...
int main()
{
    ...
    biblioteka.dodaj_uzytkownika("Marcin", "Maslak", 3);
    biblioteka.dodaj_uzytkownika("Juzek", "setter", 4);
    biblioteka.dodaj_ksiazke("Murzyn", "Jem Banany", 2, 1);
    biblioteka.dodaj_ksiazke("Mefisto", "Arka szatana", 7, 2);
